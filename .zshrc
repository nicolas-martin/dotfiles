...
export ZSH=/Users/nmartin_yyz/.oh-my-zsh
...
export PACT=~/dev/pact/bin
export PATH=$PATH:$GOBIN:$PACT
alias st='git status '
alias ga='git add '
alias br='git branch '
alias ci='git commit '
...
alias scr='/Users/nmartin_yyz/dev/scr-services/'
alias int='$GOPATH/src/github.com/saturn-sonic/interactions-services'
